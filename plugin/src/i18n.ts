...
const en: Dict = {
  ...
  openMarkdown: "Open a Markdown note first.", disabled: "Uplink is disabled.", noFiles: "No files selected.", noLocalAttachments: "No local attachments found.",
  ...
  settingsTitle: "Uplink", settingsIntro: "Upload images, PDFs, and any file directly from Obsidian to Aliyun OSS — no middleware or server required.",
...
const zh: Dict = {
  ...
  openMarkdown: "请先打开一个 Markdown 笔记。", disabled: "Uplink 已禁用。", noFiles: "未选择文件。", noLocalAttachments: "未发现本地附件。",
  ...
  settingsTitle: "Uplink", settingsIntro: "Obsidian 直接上传图片、PDF 与任意附件到阿里云 OSS；Desktop、iPhone、iPad 均无需部署中间件或服务器。",
